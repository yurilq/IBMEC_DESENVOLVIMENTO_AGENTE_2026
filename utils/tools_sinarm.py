"""
UTILS: Tools SINARM Compartilhadas
Versão: 1.0 (Base para E1-E7)

Estas tools são usadas por TODOS os encontros da disciplina.
Mudanças aqui afetam todos os agentes.
...
# Caminhos (ajustado para utils/)
BASE_DIR = Path(__file__).resolve().parent.parent  # 03_CODIGOS_PRONTOS
...
# Caminho dos dados (volta 2 níveis: 03_CODIGOS_PRONTOS -> E1_ANATOMIA -> 00_DISCIPLINAS -> E2_QUALIDADE -> DADOS_SINARM)
ARQUIVOS_DIR = BASE_DIR.parent / "E2_QUALIDADE_E_MEMORIA" / "DADOS_SINARM"
