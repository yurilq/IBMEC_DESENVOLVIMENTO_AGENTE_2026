...
# Verificar se contar_armas_marca ja eh uma tool (@tool) ou funcao normal
if hasattr(contar_armas_marca, 'name'):
    # Ja eh uma tool (tem @tool)
    tool_contar = contar_armas_marca
    print(f"      [OK] Tool '{tool_contar.name}' ja pronta (usa @tool)")
else:
    # Funcao normal - criar Tool manualmente
    tool_contar = Tool(
    ...
    print("      [OK] Tool criada manualmente")
